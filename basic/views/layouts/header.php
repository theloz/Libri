...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini"><img src="/assets/imgs/logo/logo_transparent.png" alt="App Image"/></span><span class="logo-lg"><img src="/assets/imgs/logo/logo_transparent.png" alt="App Image"/>' . Yii::$app->name . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
